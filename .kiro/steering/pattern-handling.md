---
inclusion: fileMatch
fileMatchPattern: ['src/components/**/*.tsx', 'src/hooks/**/*.ts', 'src/services/**/*.ts', 'src/managers/**/*.ts', 'src/types/**/*.ts', 'src/utils/**/*.ts', 'src/workers/**/*.ts', 'src/lib/**/*.ts', 'src/pages/**/*.tsx', 'src/contexts/**/*.tsx', 'src/styles/**/*.css', 'src/config/**/*.ts', 'src/tests/**/*.test.ts', 'src/tests/**/*.test.tsx']
---
