import { X, AlertTriangle, Rocket, Map, ChevronRight } from 'lucide-react';
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="mt-auto">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="px-4 py-2 bg-teal-600/20 hover:bg-teal-600/30 border border-teal-500/30 rounded-lg text-teal-200 text-sm transition-colors">
            Deploy Recon Ship
          </button>
