...
type Action =
  ...
  | { type: ActionType.SET_TRADE_ROUTES; payload: TradeRoute[] }
...
export const ExplorationProvider: React.FC<ExplorationProviderProps> = ({
  ...
  const getSystemsBySectorId = useCallback(
    (sectorId: string) => {
  ...
  const getPlanetsBySystemId = useCallback(
    (systemId: string) => {
  ...
  const getAnomaliesBySectorId = useCallback(
    (sectorId: string) => {
  ...
  const getAnomalyById = useCallback(
    (id: string) => {
  ...
  const getResourcesByEntityId = useCallback(
    (entityId: string) => {
  ...
  const getActivitiesByEntityId = useCallback(
    (entityId: string) => {
  ...
  return <ExplorationContext.Provider value={contextValue}>{children}</ExplorationContext.Provider>;
};
