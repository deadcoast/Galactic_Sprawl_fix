...
import { X, Star, Sword, Shield, Zap, Users, ChevronRight } from 'lucide-react';
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className={`relative w-16 h-16 rounded-lg bg-${color}-900/50 flex items-center justify-center overflow-hidden`}>
          ...
          <div>
            ...
            <div className="text-sm text-gray-400">Level {officer.level} {officer.role}</div>
          </div>
        </div>
        <button
          onClick={onClose}
              ...
              <>
                ...
                <div className="h-1.5 bg-gray-700 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${(officer.trainingProgress || 0) * 100}%` }}
                  />
                </div>
              </>
            ) : (
