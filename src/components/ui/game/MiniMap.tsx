 ...
 */
import { Move, Target, ZoomIn, ZoomOut } from 'lucide-react';
...
export function MiniMap({
  ...
  return (
    <div ref={containerRef} className={`mini-map relative ${className}`} data-testid="mini-map">
      <canvas
        ref={canvasRef}
        width={width}
        height={height}
        className="mini-map__canvas overflow-hidden rounded-lg border border-gray-700"
      ...
      {interactive && (
        <div className="mini-map__controls absolute right-2 bottom-2 flex flex-col gap-1">
          <button
            className="mini-map__control-btn flex h-6 w-6 items-center justify-center rounded-full bg-gray-800 text-white hover:bg-gray-700"
