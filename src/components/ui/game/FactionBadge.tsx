...
import { Shield, Sword, Users, Info, AlertTriangle, ThumbsUp, ThumbsDown } from 'lucide-react';
...
export function FactionBadge({
  ...
  const factionIcon = React.cloneElement(
    factionConfig.icon as React.ReactElement, 
    { className: iconSize }
  );
  ...
  return (
    ...
    >
      ...
      {showRelationship && (
        ...
        >
          <span className="faction-badge__relationship-icon mr-1">
