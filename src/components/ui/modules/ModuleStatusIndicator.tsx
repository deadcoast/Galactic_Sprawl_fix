...
export function ModuleStatusIndicator({
  ...
  if (isLoading && !statusOverride) {
    return (
      <div className={`module-status-indicator module-status-indicator--loading ${getSizeClass()} ${className}`}>
  ...
  if (error && !statusOverride) {
    return (
      <div className={`module-status-indicator module-status-indicator--error ${getSizeClass()} ${className}`}>
