...
const techNodes: TechNode[] = [
  ...
  },
  {
    ...
    description:
      "Enables production of Spitflares and Rock Breaker mining ships",
    tier: 1,
    icon: "rocket",
  ...
  // Infrastructure - Tier 2
  {
    ...
    name: "Advanced Radar",
    description:
      "Unlocks galaxy-wide monitoring, enemy detection, and enhanced mineral spotting",
    tier: 2,
    icon: "radar",
    requirements: ["basic-radar"],
    unlocked: false,
  ...
  },
  {
    ...
    description:
      "Adds Star Schooner and Orion's Frigate production capabilities",
    tier: 2,
    icon: "rocket",
    requirements: ["basic-ship-hangar"],
    unlocked: false,
  ...
  // Infrastructure - Tier 3
  {
    ...
    description:
      "Full-spectrum scanning that detects anomalies, hidden tech, and habitable worlds",
    tier: 3,
    icon: "radar",
  ...
  },
  {
    ...
    description:
      "Enables construction of capital ships like Harbringer Galleon and Midway Carrier",
    tier: 3,
    icon: "rocket",
  ...
  },
  {
    ...
    description:
      "Dynamic expansion integrating with Habitable Worlds and optimized trade routes",
    tier: 3,
    icon: "database",
  ...
  },
  {
    ...
    description:
      "Advanced energy and resource bonuses through segmented automation",
    tier: 3,
    icon: "zap",
  ...
  // Additional Infrastructure Nodes
  {
    ...
    description:
      "Improves inter-system data sharing and speeds up command decisions",
    tier: 2,
    icon: "zap",
    requirements: ["advanced-radar"],
    unlocked: false,
  ...
  },
  {
    ...
    description:
      "Automates trade routes, reduces resource latency, and improves mining efficiency",
    tier: 3,
    icon: "database",
  ...
  },
  {
    ...
    description:
      "Allows colonies to scale visually and functionally as population grows",
    tier: 3,
    icon: "database",
    requirements: ["automated-colony"],
    unlocked: false,
  ...
  // War Fleet - Tier 1
  {
    ...
    name: "Basic Weapons",
    description:
      "Unlocks Machine Gun, Rockets, and Gauss Cannon weapon systems",
    tier: 1,
    icon: "crosshair",
    requirements: [],
    unlocked: true,
  ...
  },
  {
    ...
    name: "Cutting Laser",
    description:
      "Enables war ships to salvage resources from destroyed enemy ships",
    tier: 2,
    icon: "crosshair",
  ...
  // War Fleet - Tier 3
  {
    ...
    description:
      "Unlock Spark Rounds, Big Bang Rockets, and advanced Rail Gun variants",
    tier: 3,
    icon: "crosshair",
    requirements: ["enhanced-weapons"],
    unlocked: false,
  ...
  },
  {
    ...
    description:
      "Reactive armor with smart countermeasures and kinetic absorption",
    tier: 3,
    icon: "shield",
  ...
  },
  {
    ...
    description:
      "Advanced AI system for enhanced reaction times and tactical coordination",
    tier: 3,
    icon: "ship",
  ...
  // Recon Fleet - Tier 2
  {
    ...
    description:
      "Enhanced sensor modules for improved mapping and stealth detection",
    tier: 2,
    icon: "radar",
    requirements: ["basic-sensors"],
    unlocked: false,
  ...
  // Recon Fleet - Tier 3
  {
    ...
    description:
      "Quantum-enhanced systems for superior anomaly detection and mapping",
    tier: 3,
    icon: "radar",
    requirements: ["enhanced-sensors"],
    unlocked: false,
  ...
  },
  {
    ...
    description:
      "Superior cloaking and mobility upgrades for hostile zone survival",
    tier: 3,
    icon: "shield",
  ...
  // Mining Fleet - Tier 1
  {
    ...
    description:
      "Standard mining lasers and onboard refinement for Rock Breaker",
    tier: 1,
    icon: "database",
    requirements: [],
    unlocked: true,
  ...
  // Mining Fleet - Tier 2
  {
    ...
    description:
      "Enhanced extraction rates and better resource yield probabilities",
    tier: 2,
    icon: "database",
    requirements: ["mining-lasers"],
    unlocked: false,
  ...
  },
  {
    ...
    description:
      "Enhanced algorithms for improved mineral processing efficiency",
    tier: 2,
    icon: "zap",
  ...
  },
  {
    ...
    description:
      "High-damage, energy-draining weapons that penetrate advanced armor",
    tier: 3,
    icon: "zap",
  ...
  // Defense - Tier 3
  {
    ...
    name: "Heavy Shields",
    description:
      "Advanced shields with layered defense and smart countermeasures",
    tier: 3,
    icon: "shield",
...
export function TechTree() {
  ...
  const [activeCategory, setActiveCategory] =
    useState<TechNode["category"]>("infrastructure");
  ...
  const getTierNodes = (tier: number) => {
    return techNodes.filter(
      (node) => node.tier === tier && node.category === activeCategory,
    );
  };
        ...
        {categories.map((category) => {
          ...
          return (
            <button
              key={category.id}
              onClick={() =>
                setActiveCategory(category.id as TechNode["category"])
              }
