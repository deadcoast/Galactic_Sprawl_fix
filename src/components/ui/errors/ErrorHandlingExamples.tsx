...
import { ErrorSeverity, ErrorType } from '../../../services/logging/ErrorLoggingService';
import { ResourceType } from '../../../types/resources/ResourceTypes';
import { ComponentErrorState } from './ComponentErrorState';
import { ErrorBoundary, withErrorBoundary } from './ErrorBoundary';
import { InlineNetworkError, NetworkErrorFallback } from './NetworkErrorFallback';
import { InlineResourceLoadingError, ResourceLoadingError } from './ResourceLoadingError';
...
export const WithErrorBoundaryExample = () => {
  ...
  const SafeBuggyComponent = withErrorBoundary(BuggyComponent, {
    ...
    errorType: ErrorType.RUNTIME,
    errorSeverity: ErrorSeverity.MEDIUM,
    fallback: <ComponentErrorState message="Component error caught by HOC" level="medium" />,
  });
