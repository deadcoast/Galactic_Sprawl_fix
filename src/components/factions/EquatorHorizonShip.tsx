...
export function EquatorHorizonShip({ id, name, type, status, health, maxHealth, shield, maxShield, tactics, specialAbility }: EquatorHorizonShipProps) {
  return (
