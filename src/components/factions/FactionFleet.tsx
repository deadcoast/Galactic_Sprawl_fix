      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <div className="text-sm text-gray-400">AI Adaptation Level: {Math.round(adaptiveAI.experienceLevel * 100)}%</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 mb-6">
        <div>
          <div className="flex justify-between text-sm mb-1">
            ...
            <span className={
              adaptiveAI.adaptations.combatStyle === 'aggressive' ? 'text-red-400' :
              adaptiveAI.adaptations.combatStyle === 'defensive' ? 'text-blue-400' :
              'text-green-400'
            }>
          ...
          <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
            <div
              className={`h-full rounded-full ${
                adaptiveAI.adaptations.combatStyle === 'aggressive' ? 'bg-red-500' :
                adaptiveAI.adaptations.combatStyle === 'defensive' ? 'bg-blue-500' :
                'bg-green-500'
              }`}
              style={{
        ...
        <div>
          ...
          <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
            <div
              ...
              style={{
                width: `${
                  adaptiveAI.adaptations.preferredRange === 'long' ? 100 :
                  adaptiveAI.adaptations.preferredRange === 'medium' ? 66 :
                  33
                }%`
              }}
            />
