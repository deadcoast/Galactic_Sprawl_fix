...
import { Database, AlertTriangle, Truck } from 'lucide-react';
              ...
              >
                ...
                <div 
                  className={`w-16 h-16 rounded-full bg-${color}-500/20 animate-pulse relative ${
                    isSelected ? `ring-2 ring-${color}-400 ring-offset-2 ring-offset-gray-900` : ''
                  }`}
                >
                  <div className={`w-10 h-10 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-${color}-400/30`}>
                    <div className={`w-6 h-6 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-${color}-300/40 flex items-center justify-center`}>
            ...
            >
              <div className="relative group">
                <Truck className={`w-5 h-5 ${
                  ship.status === 'mining' ? 'text-green-400' :
                  ship.status === 'returning' ? 'text-yellow-400' :
                  'text-gray-400'
                }`} />
