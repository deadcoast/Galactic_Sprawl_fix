...
export function WeaponUpgradeSystem({
  weapon,
  onUpgrade,
}: WeaponUpgradeSystemProps) {
            ...
            >
                  ...
                  >
                    ...
                    <span
                      className={
                        value >
                        weapon.currentStats[
                          stat as keyof typeof weapon.currentStats
                        ]
                          ? "text-green-400"
                          : "text-red-400"
                      }
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {upgrade.requirements.resources.map((resource, index) => (
                  ...
                  >
                    {resource.type}: {weapon.resources[resource.type] || 0}/
                    {resource.amount}
                  </div>
                ))}
              </div>
