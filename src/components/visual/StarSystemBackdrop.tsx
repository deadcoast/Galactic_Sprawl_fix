...
export function StarSystemBackdrop({
  quality,
  dayNightCycle,
}: StarSystemBackdropProps) {
  ...
  useEffect(() => {
    ...
    const layers = [
      {
        count: quality === "high" ? 100 : quality === "medium" ? 50 : 25,
        speed: 0.1,
        size: 1,
      },
      {
        count: quality === "high" ? 75 : quality === "medium" ? 35 : 15,
        speed: 0.2,
        size: 2,
      },
      {
        count: quality === "high" ? 50 : quality === "medium" ? 25 : 10,
        speed: 0.3,
        size: 3,
      },
    ];
