...
import { useFactionBehavior } from './factionHooks/useFactionBehavior';
import { useDebugOverlay } from '../../hooks/useDebugOverlay';
import { AIDebugOverlay } from '../debug/AIDebugOverlay';
import { factionConfigs } from './config/factions';
import { factionManager, type FactionState } from './factionLib/factionManager';
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className={`px-2 py-1 rounded-full text-xs ${
                    behavior.threatResponse === 'aggressive' ? 'bg-red-900/50 text-red-400' :
                    behavior.threatResponse === 'defensive' ? 'bg-yellow-900/50 text-yellow-400' :
      ...
      <div className="flex-1 p-6">
        {selectedFaction ? (
          <FactionAI
            ...
            fleetStrength={factionBehaviors[selectedFaction]?.fleetStrength || 0}
            threatLevel={0.5}
            onUpdateBehavior={() => {}}
          />
        ) : (
