...
export const Switch = forwardRef<HTMLInputElement, SwitchProps>(
  (
    ...
    const switchContainerClassName = useMemo(() => {
      ...
      return classes.join(' ');
    }, [className, size, variant, disabled, isFocused, isChecked, showError, labelPosition]);
      ...
      <div className={switchContainerClassName} style={style}>
        <div className="ui-switch-field">
          ...
          {labelPosition === 'left' && label && !hideLabel && (
            <label htmlFor={switchId} className="ui-switch-label" onClick={handleLabelClick}>
              {label}
          ...
          <div className="ui-switch-control">
            ...
            <div className="ui-switch-thumb">
              {isChecked && onIcon && (
                <div className="ui-switch-icon ui-switch-on-icon">{onIcon}</div>
              )}

              {!isChecked && offIcon && (
                <div className="ui-switch-icon ui-switch-off-icon">{offIcon}</div>
              )}
            </div>
          </div>
