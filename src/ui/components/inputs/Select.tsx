...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(({
  ...
  const hasSelection = Array.isArray(currentValue) 
  ...
  const selectContainerClassName = useMemo(() => {
    ...
    className, size, variant, disabled, isFocused, isOpen,
    showError, fullWidth, multiple, hasSelection,
    leadingIcon, trailingIcon, clearable
  ]);
  ...
  return (
    <div className={selectContainerClassName} style={style}>
      ...
      >
        {leadingIcon && (
          <div className="ui-select-leading-icon">
            {leadingIcon}
          </div>
        )}
        ...
        <div className="ui-select-value">
          ...
          {multiple && hasSelection && (
            <div className="ui-select-multiple-values">
              {Array.isArray(currentValue) && currentValue.map(val => {
