...
function isTooltipPlacement(value: unknown): value is TooltipPlacement {
  return (
    typeof value === 'string' && Object.values(TooltipPlacement).includes(value as TooltipPlacement)
  );
}
...
export const Tooltip: React.FC<TooltipProps> = ({
  ...
  const tooltipElement = (
    <div
      ...
      data-testid={dataTestId}
    >
      <div className="gs-tooltip__content">{content}</div>
  ...
  return (
    <>
      {triggerElement}
      {isVisible && (usePortal ? createPortal(tooltipElement, document.body) : tooltipElement)}
    </>
  );
};
