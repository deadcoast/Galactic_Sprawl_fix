...
import { SystemId, MessagePriority } from '../../utils/events/EventCommunication';
import { moduleEventBus, ModuleEventType } from '../../lib/modules/ModuleEvents';
import { AutomationCondition, AutomationAction } from '../../managers/game/AutomationManager';
...
export function useGlobalAutomation() {
  ...
  useEffect(() => {
    ...
    // Subscribe to automation events
    const unsubscribeStarted = moduleEventBus.subscribe('AUTOMATION_STARTED' as ModuleEventType, handleAutomationEvent);
    const unsubscribeStopped = moduleEventBus.subscribe('AUTOMATION_STOPPED' as ModuleEventType, handleAutomationEvent);
    const unsubscribeComplete = moduleEventBus.subscribe('AUTOMATION_CYCLE_COMPLETE' as ModuleEventType, handleAutomationEvent);
