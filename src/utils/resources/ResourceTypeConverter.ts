...
export class ResourceTypeConverter {
   ...
   */
  public static ensureStringResourceType(value: unknown): ResourceTypeString {
    ...
    if (typeof value === 'number' || Object.values(ResourceType).includes(value as ResourceType)) {
      ...
      if (stringValue) {
        return stringValue as ResourceTypeString;
      }
    }
    ...
    if (typeof value === 'string') {
      ...
      if (this.isValidStringType(upperValue)) {
        return upperValue as ResourceTypeString;
      }
