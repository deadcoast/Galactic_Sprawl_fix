...
export function createResponsiveHelpers(breakpoints: Theme['breakpoints']) {
  return {
     ...
     */
    up: (breakpoint: keyof Theme['breakpoints']) => `@media (min-width: ${breakpoints[breakpoint]})`,
     ...
     * @returns Media query string
     */
    down: (breakpoint: keyof Theme['breakpoints']) => `@media (max-width: ${breakpoints[breakpoint]})`,
     ...
     */
    between: (
      start: keyof Theme['breakpoints'], 
      end: keyof Theme['breakpoints']
    ) => {
