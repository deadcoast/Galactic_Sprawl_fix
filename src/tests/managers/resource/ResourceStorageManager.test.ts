...
import { ResourceStorageManager, StorageContainerConfig } from '../../../managers/resource/ResourceStorageManager';
...
describe('ResourceStorageManager', () => {
  ...
  it('should store resources in a container', () => {
    ...
    const amountStored = storageManager.storeResource('test-container', 'energy' as ResourceType, 50);
  ...
  it('should handle storage capacity limits', () => {
    ...
    const amountStored = storageManager.storeResource('test-container', 'energy' as ResourceType, 30);
  ...
  it('should retrieve resources from a container', () => {
    ...
    const amountRetrieved = storageManager.retrieveResource('test-container', 'energy' as ResourceType, 30);
  ...
  it('should not retrieve more than available', () => {
    ...
    const amountRetrieved = storageManager.retrieveResource('test-container', 'energy' as ResourceType, 70);
  ...
  it('should get containers by resource type', () => {
    ...
    const mineralContainers = storageManager.getContainersByResourceType('minerals' as ResourceType);
