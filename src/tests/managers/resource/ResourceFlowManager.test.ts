...
import { ResourceType, ResourceFlow, ResourceState } from '../../../types/resources/ResourceTypes';
import { validateResourceFlow } from '../../../utils/resources/resourceValidation';

// Import FlowNode and FlowConnection types
import type { FlowNode, FlowConnection, FlowNodeType } from '../../../managers/resource/ResourceFlowManager';
