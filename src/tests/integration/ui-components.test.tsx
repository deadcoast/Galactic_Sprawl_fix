...
describe('UI Component Integration', () => {
  ...
  it('CardWithActionButtons renders all components correctly', () => {
    renderWithProviders(
      <CardWithActionButtons title="Test Card" content="This is a test card with action buttons" />
    );
  ...
  it('InteractiveForm submits data correctly', async () => {
    ...
    const { user } = renderWithProviders(<InteractiveForm onSubmit={handleSubmit} />);
  ...
  it('handles nested components correctly', () => {
    renderWithProviders(
      <Card title="Parent Card">
        <p>Parent content</p>
        <Card title="Child Card" elevation={CardElevation.LOW}>
          <p>Child content</p>
          <Button size={ComponentSize.SMALL}>Nested Button</Button>
        </Card>
      </Card>
    );
